...
| prove_time_stdev_ms | 1011 | 68.07 | ms | sample stdev across prove runs |
| verify_time_ms | 331 | 1600 | ms | off-chain verifier |
| proof_size_bytes | 21373 | 804 | bytes | serialized proof file size |
| peak_rss_kb | 1765648 | 189932 | KB | prove step peak RSS (Linux time -v) |
