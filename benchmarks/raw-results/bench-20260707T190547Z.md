...
| prove_time_ms | 3.239e+04 | 2220 | ms | median of 3 runs |
| prove_time_stdev_ms | 543.5 | 180.1 | ms | sample stdev across prove runs |
| verify_time_ms | 585.7 | 1480 | ms | off-chain verifier |
| proof_size_bytes | 21312 | 803 | bytes | serialized proof file size |
| peak_rss_kb | 1757600 | 189640 | KB | prove step peak RSS (Linux time -v) |
