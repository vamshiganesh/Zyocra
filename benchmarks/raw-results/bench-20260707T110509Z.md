...
| prove_time_ms | 1.593e+04 | 1010 | ms | median of 3 runs |
| prove_time_stdev_ms | 1725 | 308.1 | ms | sample stdev across prove runs |
| verify_time_ms | 327.8 | 820 | ms | off-chain verifier |
| proof_size_bytes | 21476 | 808 | bytes | serialized proof file size |
| peak_rss_kb | 1764296 | 190176 | KB | prove step peak RSS (Linux time -v) |
...
| verify_gas_per_public_input | 76587 | 27167 | gas | standalone verify gas / public signals |
...
- ezkl_head: missing /home/ubuntu/projects/zyocra/Zyocra/ml-base/artifacts/onnx/zyocra-head-v1.onnx — run ml-base/scripts/export_head_onnx.py first
