...
|--------|------|--------|------|-------|
| constraint_count | 964 | 90 | count | EZKL: settings num_rows; Circom: R1CS total |
| prove_time_ms | 3.402e+04 | 1945 | ms | median of 10 runs |
| prove_time_stdev_ms | 5941 | 267.4 | ms | sample stdev across prove runs |
| verify_time_ms | 671.3 | 1580 | ms | off-chain verifier |
| proof_size_bytes | 21463 | 805 | bytes | serialized proof file size |
| peak_rss_kb | 1757890 | 190234 | KB | prove step peak RSS (Linux time -v) |
| verify_gas | 536176 | 251231 | gas | EVM verifier only (Foundry) |
| constraints_per_matmul | 321.3 | 90 | count | constraint_count / matmul_count |
| constraints_per_lora_rank_op | — | 22.5 | count | Circom head only: constraints / rank |
| verify_gas_per_public_input | 76597 | 27915 | gas | standalone verify gas / public signals |
...
- Prove times are medians of 10 runs with stdev reported; sample_indices=[0, 1, 2, 3].
