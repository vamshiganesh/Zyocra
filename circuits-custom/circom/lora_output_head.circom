 ...
 * Bias and sigmoid are intentionally out-of-circuit (same approximation
 * boundary as the EZKL full-graph baseline).
 *
 * Public:  hidden[in_dim], logit_acc (main output)
...
component main {public [hidden]} = LoRAOutputHead(8, 4);
